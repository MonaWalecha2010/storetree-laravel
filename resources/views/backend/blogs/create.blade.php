                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <img src="{{ asset('images/dummy.png') }}" id="thumbnailPreview" alt="" style="width: 100px; height: 100px;">
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    {!! Form::file('thumbnail2', null, ['class'=>'form-control']) !!}
                                </div>
                                <div class="col-md-3">
                                    <img src="{{ asset('images/dummy.png') }}" id="thumbnail2Preview" alt="" style="width: 100px; height: 100px;">
                                </div>
                                <div class="col-md-1">
