                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                {!! Form::label('home_video', 'Create Story (Step 4)') !!}
                            ...
                            <div class="form-group">
                                {!! Form::label('story_fourth_step', 'Create Story (Step 5)') !!}
                            ...
                            <div class="form-group">
                                {!! Form::label('story_fifth_step', 'Create Story (Step 6)') !!}
                    ...
                    {!! Form::model($settings, ['method'=>'POST', 'action'=>['backend\SettingController@store'], 'files'=>true]) !!}
                        <div class="form-group">
                            {!! Form::label('intro_video', 'Intro video') !!}
                            {!! Form::file('intro_video', null, ['class'=>'form-control']) !!}
                        </div>
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary">Update</button>
                        </div>
