...
<!--                        <li class="treeview {{ Helper::menuIsActive([ 'admin.relations.create', 'admin.relations.index', 'admin.relations.edit']) }}">
                        ...
                        <li class="treeview {{ Helper::menuIsActive([ 'admin.promocodes.create', 'admin.promocodes.index', 'admin.promocodes.edit']) }}">
                            <a href="#">
                            <i class="fa fa-ticket"></i> <span>Promocodes</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="{{ Helper::menuIsActive(['admin.promocodes.create']) }}">
                                    <a href="{{ route('admin.promocodes.create') }}"><i class="fa fa-plus-square"></i>New Promocode</a>
                                </li>
                                <li class="{{ Helper::menuIsActive(['admin.promocodes.index']) }}">
                                    <a href="{{ route('admin.promocodes.index') }}"><i class="fa fa-list"></i>Promocodes List</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <footer class="main-footer">
                ...
                <strong>Developed by <a href="https://storeetree.com">StoreeTree.com</a></strong>
            </footer>
