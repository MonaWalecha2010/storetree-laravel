...
@section('title')
<title>Storee Tree: Terms & Conditions</title>
@endsection
...
<div class="content_area cn_gap_top">
    <div class="common_section story_section term_conditions-sec">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                ...
                <h1>Agreement to Our Legal Terms</h1>
                        ...
                        <p>
                            We are Storee Tree, LLC, doing business as StoreeTree ("Company," "we," "us," "our"), a
                            company registered in Florida, United States at 2721 Runyon Circle, Orlando, FL 32837.
                        </p>
                        <p>
                            We operate the website <a href="http://www.Storeetree.com">http://www.Storeetree.com</a>
                            (the "Site"), the mobile application StoreeTree (the "App"), as well as any other related
                            products and services that refer or link to these legal terms (the "Legal Terms")
                            (collectively, the "Services").
                        </p>
                        <p>
                            You can contact us by email at <a href="mailto:Info@StoreeTree.com">Info@StoreeTree.com</a>,
                            or by mail to 2721 Runyon Circle, Orlando, FL 32837, United States.
                        </p>
                        <p>
                            These Legal Terms constitute a legally binding agreement made between you, whether
                            personally or on behalf of an entity ("you"), and Storee Tree, LLC, concerning your access
                        ...
                        <p>
                            ...
                            will be subject to, and will be deemed to have been made aware of and have accepted, the
                    ...
                    <div class="faq_content">
                        <div class="faq_single_block">
                            <div role="tablist" class="ui-accordion ui-widget ui-helper-reset" id="accordion">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>OUR SERVICES</h3>
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>INTELLECTUAL
                                    PROPERTY RIGHTS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">

                                    <strong>Our intellectual property</strong>
                                    <p>We are the owner or the licensee of all intellectual property rights in our
                                        ...
                                        logos contained therein (the "Marks").</p>
                                    <p>Our Content and Marks are protected by copyright and trademark laws (and various
                                        other intellectual property rights
                                        and unfair competition laws) and treaties in the United States and around the
                                        world.</p>
                                    <p>The Content and Marks are provided in or through the Services "AS IS" for your
                                    ...
                                    <p>Subject to your compliance with these Legal Terms, including the "PROHIBITED
                                        ...
                                        you a non-exclusive, non-transferable, revocable license to:</p>
                                    <ul>
                                        <li>access the Services; and</li>
                                        <li>download or print a copy of any portion of the Content to which you have
                                            properly gained access.</li>
                                    </ul>
                                    <p>solely for your personal, non-commercial use.</p>
                                    <p>Except as set out in this section or elsewhere in our Legal Terms, no part of the
                                    ...
                                    <p>If you wish to make any use of the Services, Content, or Marks other than as set
                                        out in this section or elsewhere in
                                        our Legal Terms, please address your request to: <a
                                            href="mailto:info@storeetree.com">Info@StoreeTree.com</a>. If
                                        we ever grant you the permission to post, reproduce, or publicly display any
                                        part of our Services or Content, you
                                        ...
                                        our Content.</p>
                                    <p>We reserve all rights not expressly granted to you in and to the Services,
                                        Content, and Marks.</p>
                                    <p>Any breach of these Intellectual Property Rights will constitute a material
                                        breach of our Legal Terms and your right
                                        to use our Services will terminate immediately.</p>

                                    <strong>Your submissions and contributions</strong>
                                    <p>Please review this section and the "PROHIBITED ACTIVITIES" section carefully
                                        prior to using our Services to
                                        understand the (a) rights you give us and (b) obligations you have when you post
                                        or upload any content through the
                                        Services.</p>

                                    <strong>Submissions</strong>
                                    <p>By directly sending us any question, comment, suggestion, idea, feedback, or
                                        other information about the Services
                                        ("Submissions"), you agree to assign to us all intellectual property rights in
                                        such Submission. You agree that we
                                        shall own this Submission and be entitled to its unrestricted use and
                                        dissemination for any lawful purpose,
                                        commercial or otherwise, without acknowledgment or compensation to you.</p>

                                    <strong>Contributions</strong>
                                    <p>The Services may invite you to chat, contribute to, or participate in blogs,
                                        message boards, online forums, and
                                        ...
                                        as a Contribution.</p>
                                    <p>You understand that Contributions may be viewable by other users of the Services.
                                    </p>
                                    <p>When you post Contributions, you grant us a license (including use of your name,
                                        trademarks, and logos): By posting
                                        ...
                                        reformat, translate, excerpt (in whole or
                                        ...
                                        your Contributions, and to sublicense the licenses granted in this section. Our
                                        use and distribution may occur in
                                        any media formats and through any media channels.</p>
                                    <p>This license includes our use of your name, company name, and franchise name, as
                                    ...
                                    <p>By sending us Submissions and/or posting Contributions through any part of the
                                        ...
                                        accounts, you:</p>
                                    <ul>
                                        <li>confirm that you have read and agree with our "PROHIBITED ACTIVITIES" and
                                            will not post, send, publish, upload,
                                            or transmit through the Services any Submission nor post any Contribution
                                            that is illegal, harassing, hateful,
                                            harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening
                                            to any person or group, sexually
                                            explicit, false, inaccurate, deceitful, or misleading;</li>
                                        <li>to the extent permissible by applicable law, waive any and all moral rights
                                            to any such Submission and/or
                                            Contribution;</li>
                                        <li>warrant that any such Submission and/or Contributions are original to you or
                                            that you have the necessary
                                            rights and licenses to submit such Submissions and/or Contributions and that
                                            you have full authority to grant
                                            us the above-mentioned rights in relation to your Submissions and/or
                                            Contributions; and</li>
                                        <li>warrant and represent that your Submissions and/or Contributions do not
                                            constitute confidential information.</li>
                                    </ul>
                                    <p>You are solely responsible for your Submissions and/or Contributions and you
                                        expressly agree to reimburse us for any
                                        and all losses that we may suffer because of your breach of (a) this section,
                                        (b) any third party's intellectual
                                        property rights, or (c) applicable law.</p>

                                    <strong>We may remove or edit your Content</strong>
                                    <p>Although we have no obligation to monitor any Contributions, we shall have the
                                        right to remove or edit any
                                        Contributions at any time without notice if, in our reasonable opinion, we
                                        consider such Contributions harmful or
                                        in breach of these Legal Terms. If we remove or edit any such Contributions, we
                                        may also suspend or disable your
                                        account and report you to the authorities.</p>

                                    <strong>Copyright infringement</strong>
                                    <p>We respect the intellectual property rights of others. If you believe that any
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>USER
                                    REPRESENTATIONS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    <ol>
                                        ...
                                        <li>you will maintain the accuracy of such information and promptly update such
                                            ...
                                            necessary;</li>
                                        <li>you have the legal capacity and you agree to comply with these Legal Terms;
                                        </li>
                                        <li>you are not a minor in the jurisdiction in which you reside;</li>
                                        <li>you will not access the Services through automated or non-human means,
                                            whether through a bot, script, or
                                            otherwise;</li>
                                        <li>you will not use the Services for any illegal or unauthorized purpose; and
                                        </li>
                                        <li>your use of the Services will not violate any applicable law or regulation.
                                        </li>
                                    </ol>
                                    <p>If you provide any information that is untrue, inaccurate, not current, or
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>USER REGISTRATION
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>PRODUCTS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>PURCHASES AND
                                    PAYMENT</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    <p>You agree to provide current, complete, and accurate purchase and account
                                        information for all purchases made via the
                                        ...
                                        transactions and contact you as needed. Sales
                                        tax will be added to the price of purchases as deemed required by us. We may
                                        change prices at any time. All payments
                                        shall be in US dollars.</p>

                                    <p>You agree to pay all charges at the prices then in effect for your purchases and
                                        any applicable shipping fees, and
                                        you authorize us to charge your chosen payment provider for any such amounts
                                        upon placing your order. If your order
                                        is subject to recurring charges, then you consent to our charging your payment
                                        method on a recurring basis without
                                    ...
                                    <p>We reserve the right to refuse any order placed through the Services. We may, in
                                        ...
                                        or under the same customer account, the same payment method, and/or orders that
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>REFUNDS POLICY</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">

                                    All sales are final, and no refund will be issued.
                                </div>

                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>PROHIBITED
                                    ACTIVITIES</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">

                                    <p>You may not access or use the Services for any purpose other than that for which
                                        we make the Services available.
                                        The Services may not be used in connection with any commercial endeavors except
                                        those that are specifically endorsed
                                        or approved by us.</p>
                                    <p>As a user of the Services, you agree not to:</p>
                                    <ul>
                                        <li>Systematically retrieve data or other content from the Services to create or
                                        ...
                                        <li>Circumvent, disable, or otherwise interfere with security-related features
                                            of the Services, including features
                                        ...
                                        <li>Disparage, tarnish, or otherwise harm, in our opinion, us and/or the
                                            Services.</li>
                                        <li>Use any information obtained from the Services in order to harass, abuse, or
                                            harm another person.</li>
                                        <li>Make improper use of our support services or submit false reports of abuse
                                            or misconduct.</li>
                                        ...
                                        <li>Attempt to impersonate another user or person or use the username of another
                                            user.</li>
                                        <li>Upload or transmit (or attempt to upload or to transmit) any material that
                                            ...
                                            (sometimes referred to as "spyware"
                                            or "passive collection mechanisms" or "pcms").</li>
                                        <li>Interfere with, disrupt, or create an undue burden on the Services or the
                                        ...
                                        <li>Harass, annoy, intimidate, or threaten any of our employees or agents
                                            ...
                                            Services to you.</li>
                                        <li>Attempt to bypass any measures of the Services designed to prevent or
                                            restrict access to the Services, or any
                                            portion of the Services.</li>
                                        <li>Copy or adapt the Services' software, including but not limited to Flash,
                                            PHP, HTML, JavaScript, or other code.</li>
                                        <li>Except as permitted by applicable law, decipher, decompile, disassemble, or
                                        ...
                                        <li>Make any unauthorized use of the Services, including collecting usernames
                                        ...
                                        <li>Use the Services as part of any effort to compete with us or otherwise use
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>USER GENERATED
                                    CONTRIBUTIONS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">

                                    <p>The Services may invite you to chat, contribute to, or participate in blogs,
                                        message boards, online forums, and
                                        other functionality, and may provide you with the opportunity to create, submit,
                                        ...
                                        non-proprietary.</p>
                                    <p>When you create or make available any Contributions, you thereby represent and
                                        warrant that:</p>
                                    <ul>
                                        <li>The creation, distribution, transmission, public display, or performance,
                                            and the accessing, downloading, or
                                        ...
                                        <li>You are the creator and owner of or have the necessary licenses, rights,
                                            ...
                                            to use and to authorize us, the Services, and other users of the Services to
                                        ...
                                        <li>You have the written consent, release, and/or permission of each and every
                                            identifiable individual person in
                                            your Contributions to use the name or likeness of each and every such
                                            identifiable individual person to
                                            enable inclusion and use of your Contributions in any manner contemplated by
                                            the Services and these Legal
                                            Terms.</li>
                                        <li>Your Contributions are not false, inaccurate, or misleading.</li>
                                        <li>Your Contributions are not unsolicited or unauthorized advertising,
                                            promotional materials, pyramid schemes,
                                            chain letters, spam, mass mailings, or other forms of solicitation.</li>
                                        <li>Your Contributions are not obscene, lewd, lascivious, filthy, violent,
                                            harassing, libelous, slanderous, or
                                            otherwise objectionable (as determined by us).</li>
                                        <li>Your Contributions do not ridicule, mock, disparage, intimidate, or abuse
                                            anyone.</li>
                                        <li>Your Contributions are not used to harass or threaten (in the legal sense of
                                            those terms) any other person
                                        ...
                                        <li>Your Contributions do not violate the privacy or publicity rights of any
                                            third party.</li>
                                        <li>Your Contributions do not violate any applicable law concerning child
                                            pornography or otherwise intended to
                                            protect the health or well-being of minors.</li>
                                        <li>Your Contributions do not include any offensive comments that are connected
                                            to race, national origin, gender,
                                            sexual preference, or physical handicap.</li>
                                        <li>Your Contributions do not otherwise violate, or link to material that
                                            violates, any provision of these Legal
                                            Terms, or any applicable law or regulation.</li>
                                    </ul>
                                    <p>Any use of the Services in violation of the foregoing violates these Legal Terms
                                        and may result in, among other
                                        things, termination or suspension of your rights to use the Services.</p>

                                </div>

                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>CONTRIBUTION
                                    LICENSE</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">

                                    <p>By posting your Contributions to any part of the Services or making Contributions
                                    ...
                                    <p>This license will apply to any form, media, or technology now known or hereafter
                                        developed and includes our use of
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>GUIDELINES FOR
                                    REVIEWS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    <ol>
                                        <li>You should have firsthand experience with the person/entity being reviewed;
                                        </li>
                                        <li>Your reviews should not contain offensive profanity or abusive, racist,
                                            offensive, or hateful language;</li>
                                        <li>Your reviews should not contain discriminatory references based on religion,
                                        ...
                                        <li>You should not be affiliated with competitors if posting negative reviews;
                                        </li>
                                        ...
                                        <li>You may not organize a campaign encouraging others to post reviews, whether
                                    ...
                                    <p>
                                        ...
                                        perform, and/or distribute all content relating to the review.
                                    </p>
                                </div>

                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>MOBILE APPLICATION
                                    LICENSE</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    <ol>
                                        <li>Except as permitted by applicable law, decompile, reverse engineer,
                                            disassemble, attempt to derive the source code of, or decrypt the App;</li>
                                        <li>Make any modification, adaptation, improvement, enhancement, translation, or
                                            derivative work from the App;</li>
                                        <li>Violate any applicable laws, rules, or regulations in connection with your
                                            access or use of the App;</li>
                                        <li>Remove, alter, or obscure any proprietary notice (including any notice of
                                            copyright or trademark) posted by us or the licensors of the App;</li>
                                        <li>Use the App for any revenue-generating endeavor, commercial enterprise, or
                                            other purpose for which it is not designed or intended;</li>
                                        <li>Make the App available over a network or other environment permitting access
                                            or use by multiple devices or users at the same time;</li>
                                        <li>Use the App for creating a product, service, or software that is, directly
                                            or indirectly, competitive with or in any way a substitute for the App;</li>
                                        <li>Use the App to send automated queries to any website or to send any
                                            unsolicited commercial email; or</li>
                                        <li>Use any proprietary information or any of our interfaces or our other
                                    ...
                                    <p>
                                        ...
                                        Store or Google Play (each an "App Distributor") to access the Services:
                                    </p>
                                    <ol>
                                        <li>The license granted to you for our App is limited to a non-transferable
                                            ...
                                            rules set forth in the applicable App Distributor's terms of service;</li>
                                        <li>We are responsible for providing any maintenance and support services with
                                        ...
                                        <li>In the event of any failure of the App to conform to any applicable
                                            ...
                                            obligation whatsoever with respect to the App;</li>
                                        <li>You represent and warrant that (i) you are not located in a country that is
                                            ...
                                            on any US government list of prohibited or restricted parties;</li>
                                        <li>You must comply with applicable third-party terms of agreement when using
                                        ...
                                        <li>You acknowledge and agree that the App Distributors are third-party
                                            ...
                                            Terms against you as a third-party beneficiary thereof.</li>
                                    </ol>
                                </div>

                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>SOCIAL MEDIA</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    <p>
                                    ...
                                    <ol>
                                        <li>Providing your Third-Party Account login information through the Services;
                                            or</li>
                                        <li>Allowing us to access your Third-Party Account, as is permitted under the
                                    ...
                                    <ol>
                                        <li>We may access, make available, and store (if applicable) any content that
                                            ...
                                            your account, including without limitation any friend lists.</li>
                                        <li>We may submit to and receive from your Third-Party Account additional
                                            information to the extent you are notified when you link your account with
                                            the Third-Party Account.</li>
                                    </ol>
                                    <p>
                                    ...
                                    <p>
                                        <strong>PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE
                                            PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY
                                            YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS.</strong>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        contacts who have also registered to use the Services.
                                    </p>
                                    <p>
                                        You can deactivate the connection between the Services and your Third-Party
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>ADVERTISERS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>SERVICES MANAGEMENT
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    <p>
                                    ...
                                    <ol>
                                        ...
                                        <li>Take appropriate legal action against anyone who, in our sole discretion,
                                            violates the law or these Legal Terms, including without limitation,
                                            reporting such user to law enforcement authorities;</li>
                                        <li>In our sole discretion and without limitation, refuse, restrict access to,
                                        ...
                                        <li>In our sole discretion and without limitation, notice, or liability, to
                                        ...
                                        <li>Otherwise manage the Services in a manner designed to protect our rights and
                                            property and to facilitate the proper functioning of the Services.</li>
                                    </ol>
                                </div>

                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>PRIVACY POLICY</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    We care about data privacy and security. Please review our Privacy Policy. By using
                                    the Services, you agree to be bound by our Privacy Policy, which is incorporated
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>COPYRIGHT
                                    INFRINGEMENTS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    We respect the intellectual property rights or others. If you believe that any
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>TERM AND
                                    TERMINATION</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>MODIFICATIONS AND
                                    INTERRUPTIONS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    no obligation to update any information on our Services. We also reserve the right
                                    to modify or discontinue all or part of the Services without notice at any time. We
                                    will not be liable to you or any third party for any modification, price change,
                                    suspension. or discontinuance or the Services.
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>GOVERNING LAW</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    These Legal Terms and your use or the Services are governed by and construed in
                                    accordance with the laws or the State or Florida applicable to agreements made and
                                    to be entirely performed within the State of Florida, without regard to its conflict
                                    of law principles.
                                </div>

                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>DISPUTE RESOLUTION
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    <p>
                                        ...
                                        the AAP's Supplementary Procedures for Consumer Related Disputes (AAA Consumer
                                        ...
                                        law, the arbitration will take place in Dade, Florida. Except as otherwise
                                        provided herein, the Parties may litigate in court to compel arbitration, stay
                                        proceedings pending arbitration, or to confine, modify, vacate, or enter
                                    ...
                                    <p>
                                        ...
                                        in Dade, Florida, and the Parties hereby consent to, and waive all defenses of
                                    ...
                                    <p>
                                        ...
                                        the Parties individually. To the full extent permitted by law:
                                    </p>
                                    <ol>
                                        <li>No arbitration shall be joined with any other proceeding;</li>
                                        <li>There is no right or authority for any Dispute to be arbitrated on a
                                            class-action basis or to utilize class action procedures; and</li>
                                        <li>There is no right or authority for any Dispute to be brought in a purported
                                    ...
                                    <ol>
                                        <li>Any Disputes seeking to enforce or protect, or concerning the validity of
                                            any of the intellectual property rights of a Party;</li>
                                        <li>Any Dispute related to, or arising from, allegations of theft, piracy,
                                            invasion of privacy, or unauthorized use; and</li>
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>CORRECTIONS</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>DISCLAIMER</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    <ol>
                                        ...
                                        <li>Personal injury or property damage of any nature whatsoever, resulting from
                                            your access to and use of the Services;</li>
                                        <li>Any unauthorized access to or use of our secure servers and/or any and all
                                            personal information and/or financial information stored therein;</li>
                                        <li>Any interruption or cessation of transmission to or from the Services;</li>
                                        <li>Any bugs, viruses, trojan horses, or the like which may be transmitted to or
                                            through the Services by any third party; and/or</li>
                                        <li>Any errors or omissions in any content and materials or for any loss or
                                            damage of any kind incurred as a result of the use of any content posted,
                                            transmitted, or otherwise made available via the Services.</li>
                                    </ol>
                                    <p>
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>LIMITATIONS OF
                                    LIABILITY</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    <p>
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>INDEMNIFICATION
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    <p>
                                    ...
                                    <ol>
                                        ...
                                        <li>Any breach of your representations and warranties set forth in these Legal
                                            Terms;</li>
                                        <li>Your violation of the rights of a third party, including but not limited to
                                            intellectual property rights; or</li>
                                        <li>Any overt harmful act toward any other user of the Services with whom you
                                            connected via the Services.</li>
                                    </ol>
                                    <p>
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>USER DATA</h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>ELECTRONIC
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>CALIFORNIA USERS
                                    AND RESIDENTS
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>MISCELLANEOUS
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    ...
                                    these Legal Tenns shall not operate as a waiver of such right or provision. These
                                ...
                                <h3 role="tab"><span class="ui-accordion-header-icon ui-icon"></span>CONTACT US
                                </h3>
                                <div aria-hidden="false" aria-expanded="true" role="tabpanel" style="display: block;">
                                    <p>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="faq_top_section">
                        <p>Don&apos;t see the answer to your question, click <a
                                href="https://storeetree.com/contact-us"><u>here</u></a> to contact us.</p>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="testimonial_wrapper">
                                        <div class="testimonial_single">
                                            <div class="testimonial_content">
                                                <p>Sometimes all it takes is ONE Person, ONE Story, ONE Lesson learned -
                                                    to change a life.</p>
                                            </div>
                                        </div>
                                    </div>
