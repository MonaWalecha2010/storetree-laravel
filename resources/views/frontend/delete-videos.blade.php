...
<div id="messageContainer"></div>
                        ...
                        <div class="profile_content_row" id="editForm">                            
                                   {!! Form::open(['method'=>'POST', 'action'=>'frontend\ProfileController@delete_videos']) !!}
                               <ul>  
                                          @csrf
                                    <li>
                                    ...
                                    <li>
                                        <div class="profile_col_1">
                                            ...
                                            <div class="d-flex  flex-row-reverse del_acc_popup_main">
                                                <a href="#" data-toggle="modal" data-target="#confirmation-modal" data-dismiss="modal" class="del_acc_popup">Delete Videos</a>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="col-xs-12">
                                <div class="modal-block">
                                    <div class="modal-form text-center">
                                    	<p>Warning ! You will loose your data  including your Stories and Addon Videos and cannot recover your data after the current operation. </p>
                                       <h4>Are you sure you want to delete your Videos?</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
