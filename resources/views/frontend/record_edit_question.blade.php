                                            ...
                                            @foreach($questions as $question)
                                                @if ($question->class === "qs_complete" || $question->class === "qs_complete qs_qurrent")
                                                    <li class="qs_complete">
                                                        <a href="{{ route('create-your-story.edit_question.show',['id' => $question->id,'story_id' => encrypt($story_id)]) }}" class="bookmark-fill">{{ $question->title }}</a>
                                                    </li>
                                                    @continue
                                                @elseif($next)
            ...
            <div class="row">
                <div class="col-xs-12 padding_cs_1">
                    <div class="step_bottom_section">
                        <div class="step_next"><a href="{{ route('create-your-story.editstep-6', ['story_id' => encrypt($story_id)]) }}" class="btn step_next_btn" >Next</a></div><!--step_next-->
...
@section('scripts')
    <script src="{{ asset('js/app.js?09l') }}"></script>
    <script>
