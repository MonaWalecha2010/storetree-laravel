                    ...
                    <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    @else
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>To be Paid</td>
                                                <td class="price_col" id="price_section2">${{number_format(config('plans.' . Session::get('cart')['plan']. '.price') - config('plans.' . Auth::user()->plan_purchased. '.price'), 2, '.', '')+number_format($addon_charges)}}</td>
                                            </tr>
                                    @endif
                                    </tbody>
                       ...
                       @if(Auth::user()->plan_purchased == null)
                        ...
                        <div class="pay_form_body">
                            @if(Session('cart')['addon_video'])
                            <input  type="text" hidden name="price" id="price_value"  value="{{$addon_charges}}">

<input type="text" hidden name="user_name" id="user_name"  value="{{Auth::user()->first_name}} {{Auth::user()->first_name}}">
