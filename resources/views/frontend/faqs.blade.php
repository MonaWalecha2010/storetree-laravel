            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="faq_top_section">
                        ...
                        <p>Thank you for your interest in the StoreeTree Memory Maker. Below are some common questions we have run across.</p>
                        <p>Don&apos;t see the answer to your question, click <a href="https://storeetree.com/contact-us"><u>here</u></a> to contact us – we are happy to help.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <div class="testimonial_wrapper">
                                        <div class="testimonial_single">
                                            <div class="testimonial_content">
                                                <p>Sometimes all it takes is ONE Person, ONE Story, ONE Lesson learned - to change a life.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
