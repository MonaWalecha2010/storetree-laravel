                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="choose_select_common">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="av_check">
                                    @if(isset($cart['questions']))
                                         <input name="questions[]" value="{{ $question->id }}" id="ct1_{{ $question->id }}" type="checkbox" class="question-check" onchange="QuestionPlanCheck('{{ $question->id }}')"  @if(in_array($question->id, $cart['questions'])) checked @endif>
                                    @else
                                        <input name="questions[]" value="{{ $question->id }}" id="ct1_{{ $question->id }}" type="checkbox" class="question-check" onchange="QuestionPlanCheck('{{ $question->id }}')" @if(isset($questions_ids)) @if(in_array($question->id, $questions_ids)) checked @endif @endif >
                                    @endif
