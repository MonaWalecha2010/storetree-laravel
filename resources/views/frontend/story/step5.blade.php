                                            ...
                                            @foreach($questions as $question)
                                                @if ($question->class === "qs_complete" || $question->class === "qs_complete qs_qurrent")
                                                    <li class="qs_complete">
                                                        <a href="{{ route('create-your-story.step-5.show', $question->id) }}" class="bookmark-fill">{{ $question->title }}</a>
                                                    </li>
                                                    @continue
                                                @elseif($next)
                                                    ...
                                                    <li class="{{ $question->class }}">
                                                        ...
                                                        <a href="{{ route('create-your-story.step-5') }}" class="bookmark-fill">{{ $question->title }} </a>
                                                    </li>
                                                @else
                                                    <li class="{{ $question->class }}">
            ...
            <div class="row">
                <div class="col-xs-12 padding_cs_1">
                    <div class="step_bottom_section">
                        <div class="step_next"><a href="{{ route('create-your-story.step-6') }}" class="btn step_next_btn" >Next</a></div><!--step_next-->
...
@section('scripts')
    <script src="{{ asset('js/app.js?109') }}"></script>
    <script>
